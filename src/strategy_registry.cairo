...
@view
func get_strategy_hash{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    _protocol: felt
) -> (strategy_hash: felt) {
...
@view
func get_wrapped_token{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    _underlying: felt, _protocol: felt
) -> (wrapped_token: felt) {
...
@view
func get_underlying_token{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    _wrapped: felt
) -> (_protocol: felt, underlying_token: felt) {
...
@external
func set_asset_strategy{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    ...
    wrapped_to_underlying_protocol.write(
        _wrapped_asset, Asset_Protocol(_underlying_asset, _protocol)
    );
    return ();
}

@external
func set_protocol_strategy{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
