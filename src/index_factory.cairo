...
@external
func create_index{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    _name: felt,
    _symbol: felt,
    _assets_len: felt,
    _assets: felt*,
    ...
    // Deploy Index
    let (new_index_address) = deploy(class_hash, current_salt, 3, calldata, 0);
...
@external
func set_index_hash{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    _index_hash: felt
) {
...
@external
func set_index_registry{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    _new_registry: felt
) {
    Ownable.assert_only_owner();
