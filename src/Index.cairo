...
func constructor{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    name: felt, symbol: felt, initial_owner: felt
) {
...
@view
func num_assets{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (num: felt) {
    let (num) = INDEX_num_assets.read();
    return (num,);
}

@view
func assets{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(index: felt) -> (
    asset: Asset
) {
...
@view
func mint_fee{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (fee: felt) {
    let (fee) = INDEX_mint_fee.read();
    return (fee,);
}

@view
func burn_fee{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (fee: felt) {
    let (fee) = INDEX_burn_fee.read();
    return (fee,);
}

@view
func get_amounts_to_mint{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    amount_out: Uint256
...
@external
func get_amount_to_mint{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    index: felt, amount_out: Uint256
) -> (amount: Uint256) {
    let (amounts: Uint256*) = Index_Core._get_amounts_to_mint(amount_out);
...
@external
func mint{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(amount_out: Uint256) {
    alloc_locals;
...
@external
func update_fee_recipient{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
...
@external
func update_mint_fee{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    new_fee: felt
) {
    Ownable.assert_only_owner();
...
@external
func update_burn_fee{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    new_fee: felt
) {
    Ownable.assert_only_owner();
